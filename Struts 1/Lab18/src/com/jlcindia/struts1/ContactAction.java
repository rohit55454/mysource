...
public class ContactAction extends LookupDispatchAction{
	...
	protected Map<String, String> getKeyMethodMap() {
		...
		map.put("add.contact",	 "addContact");
		map.put("search.contact","searchContact");
		map.put("edit.contact",	 "editContact");
		map.put("update.contact",	 "updateContact");
