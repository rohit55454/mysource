...
@WebServlet(name="regServlet", urlPatterns={"/register.jlc"}, loadOnStartup=1)

public class RegisterServlet extends HttpServlet{
	/**
	 * 
	 */
	private static final long serialVersionUID = -151873426510726835L;
